function net = init_model_mot_v2(dst_path, opts, fc4var, fc5var)
...
if exist(dst_path,'file')
    ...
    % modify to accept 6 channels, not just 3
    conv1filters = simplenn_net.layers{1}.filters;
    conv1filters = cat(3, conv1filters, 0.01 * randn(size(conv1filters)));
    simplenn_net.layers{1}.filters = conv1filters;

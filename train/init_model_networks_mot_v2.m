function net = init_model_networks_mot_v2(layers, fc4var, fc5var)
% INIT_MODEL_NETWORKS 
% 
% Sangdoo Yun, 2017.
...
new_layers{end+1} = struct('type', 'conv', ...
                           'name', 'fc4', ...
                           'filters', 0.01/scal * randn(3,3,last_dim,fc4var,'single'),...
                           'biases', init_bias*ones(1,fc4var,'single'), ...
                           'stride', 1, ...
                           'pad', 0, ...
...
new_layers{end+1} = struct('type', 'conv', ...
                           'name', 'fc5', ...
                           'filters', 0.01/scal * randn(1,1,fc4var,fc5var,'single'),...
                           'biases', init_bias*ones(1,fc5var,'single'), ...
                           'stride', 1, ...
                           'pad', 0, ...
                           'filtersLearningRate', 10, ...
                           'biasesLearningRate', 20, ...
...
new_layers{end+1} = struct('type', 'conv', ...
                           'name', 'fc6', ...
                           'filters', 0.01/scal * randn(1,1,fc5var,2,'single'), ...

function net = adnet_train_RL_mot_v2(net, all_vid_info, opts, tail, fc5var)
...
%         net.params(net.getParamIndex(fc_layer_score.params{2})).value ...
%             = dummy_score_net.params(dummy_score_net.getParamIndex(fc_layer_score.params{2})).value;
...
%                 this_actions = zeros(num_show_actions, 1);
            ...
            for frameIdx = frameStart+1:frameEnd
                ...
                [curr_bboxes, action_history, ~, ~, ims, actions, ah_threehot, ~] = ...
                    tracker_rl_mot_v2(curr_img, curr_bboxes, net_conv, net_fc, action_history, opts);    % alg 1 line 8

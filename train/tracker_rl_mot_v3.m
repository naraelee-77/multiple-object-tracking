function [curr_bboxes, action_history, this_actions, conv_feats, ims, actions, ah_threehot, fr_toc] = ...
    tracker_rl_mot_v3(curr_img, curr_bboxes, my_net_conv, my_net_fc, action_history, opts)
% TRACKER_RL
% 
% Sangdoo Yun, 2017.
...
while (move_counter <= num_action_step_max)
    ...
    [curr_feat_conv, im] = get_conv_feature_v3(my_net_conv, curr_img, curr_bboxes, opts);
    ims(:,:,:, move_counter) = im;

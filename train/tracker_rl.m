...
while (move_counter <= num_action_step_max)
    ...
    my_net_fc.mode = 'test';
    labels = zeros(1);
    ah_oh = get_action_history_onehot(action_history(1:opts.num_action_history), opts); % get 10 most recent actions in onehot form
    ...
    curr_bbox = do_action(curr_bbox, opts, my_net_max_action, imSize);  % alg 2 line 8
